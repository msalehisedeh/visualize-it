...
export class AppService {
  ...
  private data = {
    ...
    names: [
      ...
      {"id":"10", data: {name: "Mike", age: 29, gender: "male", score: 9678678}, "size": 10, "group": 6, "name": "Mike", type:"cross", destinations:["3"]},
      {"id":"11", data: {name: "Erick", age: 31, gender: "male", score: 2332323}, "size": 60, "group": 8, "name": "Erick", type:"circle" },
      {"id":"12", data: {name: "Gyline", age: 20, gender: "female", score: 6556544}, "size": 10, "group": 1, "name": "Gyline", type:"circle", image:  "http://marvel-force-chart.surge.sh/marvel_force_chart_img/top_blackwidow.png"},
      {"id":"13", data: {name: "Hakim", age: 22, gender: "male", score: 3232434}, "size": 10, "group": 1, "name": "Hakim", type:"circle", image:  "http://marvel-force-chart.surge.sh/marvel_force_chart_img/top_thor.png"}
    ]
  }
